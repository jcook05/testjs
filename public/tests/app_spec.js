...
describe('LearnJS', function() {
    ...
    it('shows the landing page view page when # provided as hash', function() {
        learnjs.showView('#');
        expect($('.view-container .landing-view').length).toEqual(1);
      });

    it('shows the landing page view when hash is #landing', function() {
        learnjs.showView('#landing');
        expect($('.view-container .landing-view').length).toEqual(1);
      });
